        ...
        <div v-show="show">
          <v-card-text class="pt-0">
            ...
            <v-tabs-items v-model="tab">
              ...
              <v-tab-item>
                <ApolloQuery
                  :query="require('@/graphql/config/hobbies.gql')"
                  :variables="{ searchText }"
                >
                  <ApolloSubscribeToMore
                    :document="require('@/graphql/config/hobbyAdded.gql')"
              ...
              <v-tab-item>
                <ApolloMutation
                  :mutation="require('@/graphql/config/addOrUpdateHobbies.gql')"
                  :variables="{
                    hobbyData: hobbyData,
                  }"
                  class="form"
...
import HOBBIES_QUERY from "@/graphql/config/hobbies.gql";
import DELETE_QUERY from "@/graphql/config/deleteHobby.gql";
...
export default {
  ...
  methods: {
    ...
    remove(data, item) {
      ...
      // const index = this.emojis.indexOf(item.name);
      // if (index >= 0) this.emojis.splice(index, 1);
    },
    savedHobby() {
    ...
    deleteItem(item) {
      ...
      this.$apollo.mutate({
        ...
        update: (
          ...
          // const indexToDelete = data.hobbies.findIndex((x) => x.id === id);
          // data.hobbies.splice(indexToDelete, 1);
